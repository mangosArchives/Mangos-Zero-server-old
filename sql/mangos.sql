...
CREATE TABLE `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `index_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=590006 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `creature_template` (
  ...
  `dmgschool` tinyint(4) unsigned NOT NULL DEFAULT '0',
  ...
  `family` tinyint(4) unsigned NOT NULL DEFAULT '0',
  `trainer_type` tinyint(4) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `db_version` (
  ...
  `required_z1840_xxxxx_01_mangos_creature_template` bit(1) DEFAULT NULL
...
CREATE TABLE `gameobject` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=632447 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Gameobject System';
/*!40101 SET character_set_client = @saved_cs_client */;
